...
@description('The Azure Spring Cloud SKU name. Check it out at https://docs.microsoft.com/en-us/rest/api/azureSpringApps/skus/list#code-try-0')
@allowed([
  'BO'
  'S0'
  'E0'
...
@description('The Azure Spring Cloud SKU Tier. Check it out at https://docs.microsoft.com/en-us/rest/api/azureSpringApps/skus/list#code-try-0')
